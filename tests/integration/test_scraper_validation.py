...
class TestScraperValidation:
    ...
    def test_high_quality_record_validation(self, data_quality_scorer, sample_high_quality_record):
        ...
        assert is_product_high_quality(sample_high_quality_record), "High-quality record not recognized"
    ...
    def test_low_quality_record_validation(self, data_quality_scorer, sample_low_quality_record):
        ...
        assert not is_product_high_quality(sample_low_quality_record), "Low-quality record incorrectly recognized as high quality"

    def test_mixed_quality_batch_validation(self, data_quality_scorer, sample_mixed_quality_records):
...
class TestPerformanceValidation:
    ...
    def test_large_dataset_performance(self, data_quality_scorer, performance_test_data, time_monitor, memory_monitor):
        ...
        assert high_quality_count == len(performance_test_data), "Not all records recognized as high quality"

        print(f"Performance test results: {elapsed_seconds:.2f}s, {memory_delta_mb:.2f}MB memory delta")

    def test_individual_record_performance(self, data_quality_scorer, sample_high_quality_record, time_monitor):
        ...
        print(f"Individual record performance: {avg_time_ms:.2f}ms average, {max_time_ms:.2f}ms max")
