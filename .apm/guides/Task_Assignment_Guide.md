...
[Manager fills this section with section §7 content guidance, including explicit guide references for Debug/Research delegations(guides/Debug_Delegation_Guide.md or guides/Research_Delegation_Guide.md)]
```
...
- **Debug Delegation**: Reference guides/Debug_Delegation_Guide.md
- **Research Delegation**: Reference guides/Debug_Delegation_Guide.md  
