...
**Content Definition:**
- If flagged in §4.1, first add an ad-hoc delegation step: "Ad-Hoc Delegation – <purpose>" (optional ref to guides/Research_Delegation_Guide.md or guides/Debug_Delegation_Guide.md), then continue
...
- Iterate until explicit User approval to proceed to guides/Project_Breakdown_Review_Guide.md
