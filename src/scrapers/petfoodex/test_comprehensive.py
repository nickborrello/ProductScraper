#!/usr/bin/env python3
"""
Comprehensive Test Suite for PetFoodEx Scraper

This test suite provides comprehensive testing for the PetFoodEx scraper,
...
try:
    ...
    # PetFoodEx scraper may not have TEST_SKU defined, use a default
    TEST_SKU = getattr(sys.modules.get('main', {}), 'TEST_SKU', 'PETFOODEX_TEST_001')
except ImportError as e:
    print(f"❌ Failed to import scraper modules: {e}")
    sys.exit(1)


class TestPetFoodExScraper(unittest.TestCase):
    """Comprehensive test suite for PetFoodEx scraper."""

    def setUp(self):
        """Set up test fixtures."""
        self.test_sku_valid = TEST_SKU  # Known valid SKU or default
        self.test_sku_invalid = "INVALID_PETFOODEX_123"  # Invalid SKU for testing
...
class TestRunner:
    ...
    def run_tests(self, test_pattern='*'):
        ...
        print("🚀 Starting PetFoodEx Scraper Test Suite")
        print("=" * 60)
        ...
        suite = loader.loadTestsFromTestCase(TestPetFoodExScraper)
...
def run_cli_tests():
    ...
    parser = argparse.ArgumentParser(description="PetFoodEx Scraper Test Suite")
